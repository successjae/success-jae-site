...
// Chrome/Twitter brand icons were removed from lucide-react; Globe and AtSign stand in
import { Eye, EyeOff, Mail, Lock, Globe, AtSign, Gamepad2 } from 'lucide-react';
		...
		<div className="p-8 rounded-2xl backdrop-blur-sm bg-black/50 border border-white/10">
			<div className="mb-8 text-center">
				...
				<p className="text-white/80 flex flex-col items-center space-y-1">
					...
					<span className="flex space-x-2 text-xs text-white/40">
